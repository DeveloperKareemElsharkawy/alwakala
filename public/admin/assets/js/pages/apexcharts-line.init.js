...
var linechartBasicChart = "", linechartZoomChart = "", linechartDatalabelChart = "", linechartDashedChart = "",
    linechartannotationsChart = "", brushchartLine2Chart = "", brushchartLineChart = "", steplineChartChart = "",
    lineChartGradientChart = "", linechartMissingDataChart = "", linechartrealtimeChart = "",
    chartSyncingLineChart = "", chartSyncingLine2Chart = "", chartSyncingAreaChart = "";

function loadCharts() {
    (g = getChartColorsArray("line_chart_basic")) && (y = {
        series: [{
            name: "Desktops",
            data: [10, 100, 20, 200 , 30 , 250]
        }],
        chart: {height: 200, type: "line", zoom: {enabled: !1}, toolbar: {show: 0}},
        markers: {size: 4},
        dataLabels: {enabled: !1},
        stroke: {curve: "straight"},
        colors: g,

    }, "" != linechartBasicChart && linechartBasicChart.destroy(), (linechartBasicChart = new ApexCharts(document.querySelector("#line_chart_basic"), y)).render())
        , (g = getChartColorsArray("line_chart_zoomable")) && (y = {
        series: [{
            name: "XYZ MOTORS",
    ...
    (linechartannotationsColors = getChartColorsArray("line_chart_annotations")) && (y = {
        ...
        annotations: {
            yaxis: [{
                y: 8200,
                borderColor: "#038edc",
                label: {borderColor: "#038edc", style: {color: "#fff", background: "#038edc"}, text: "Support"}
            }, {
                y: 8600,
                y2: 9e3,
                borderColor: "#f7cc53",
            ...
            xaxis: [{
                ...
                strokeDashArray: 0,
                borderColor: "#564ab1",
                label: {borderColor: "#564ab1", style: {color: "#fff", background: "#564ab1"}, text: "Anno Test"}
            }, {
    ...
    var r = function (e, t, a) {
            for (var r = 0, n = []; r < t;) {
                var i = e, o = Math.floor(Math.random() * (a.max - a.min + 1)) + a.min;
        ...
        r = [], i = 864e5, o = 7776e5;
    for (var e = new Date("11 Feb 2017 GMT").getTime(), t = 10, a = {min: 10, max: 90}, l = 0; l < t;) {
        var s = e, h = Math.floor(Math.random() * (a.max - a.min + 1)) + a.min;
