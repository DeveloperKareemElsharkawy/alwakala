...
Route::group(['prefix' => 'seller-app', 'namespace' => 'Seller'], function () {
    ...
    Route::group(['prefix' => 'sellers', 'middleware' => 'seller_auth'], function () { // apis for seller
        ...
        Route::post('/update-email', 'SellersController@sendUpdateEmailCode')->middleware('seller_can_access:sEditProfile');
        Route::post('/update-email/resend-code', 'SellersController@sendUpdateEmailCode')->middleware('seller_can_access:sEditProfile');
        Route::post('/update-email/confirm', 'SellersController@updateEmailConfirmation')->middleware('seller_can_access:sEditProfile');
    });
...
//            Route::post('/toggle-favorite-store', 'StoresController@toggleFavoriteStore')->middleware('seller_can_access:sToggleFavoriteStore');
    ...
    Route::group(['prefix' => 'offers', 'middleware' => 'seller_auth'], function () {
        ...
        Route::get('global/approved-stores-list', 'OffersController@allEnrolledStores')->middleware('seller_can_access:sIndexAddresses');
        Route::get('global/rejected-stores-list', 'OffersController@allRejectedStores')->middleware('seller_can_access:sIndexAddresses');
        Route::get('global/pending-stores-list', 'OffersController@allPendingStores')->middleware('seller_can_access:sIndexAddresses');
    });
    ...
    Route::group(['prefix' => 'orders', 'middleware' => ['seller_auth', 'user_activation']], function () {
        ...
        Route::post('/add-order-old', 'OrdersController@addOrder')->middleware('seller_can_access:sAddOrder');
