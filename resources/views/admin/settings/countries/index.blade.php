                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <ul class="nav nav-tabs nav-justified mb-1 settings_tabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="settings-country.html">
                                                الدولة
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="settings-government.html">
                                                المحافظة
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="settings-city.html">
                                                المدينة
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="settings-district.html">
                                                الولاية
                                            </a>
                                        </li>
                                    </ul>
