        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header d-block text-center">
                    <h5 class="modal-title" id="exampleModalgridLab">اضافة خامة جديد</h5>
                </div>
                <div class="modal-body px-5">
                    <form class="my_form px-5" method="post" action="{{ url('admin_panel/settings/materials') }}">
                        {{ csrf_field() }}
                        <div class="row g-3">
                                                    ...
                                                    <div class="card-body pt-0">
                                                        ...
                                                        <div class="table-responsive">
                                                            <table id="user_example" class="dataTable row-border"
                                                                ...
                                                                <tbody>
                                                                @foreach($materials as $key => $color)
                                                                    <tr class="image_class{{ $color['id'] }}">
                                                                        ...
                                                                        <td class="materials">
                                                                            <div class="form-check form-switch form-switch-success d-inline-block">
                                                                                <input class="form-check-input active" model_type="Material" model_id="{{ $color['id'] }}" type="checkbox" role="switch" id="SwitchCheck3" {{ $color['activation'] == true ? 'checked' : '' }}>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <ul class="actions-list">
                                                                                ...
                                                                                <li>
                                                                                    ...
                                                                                    @else
                                                                                        <a title="archive" delete_url="settings/materials/archive/"
                                                                                           object_id="{{ $color['id'] }}" data-bs-toggle="tooltip"
...
@section('backend-footer')
    ...
    <script>
        ...
        $("body").on("click", ".edit-btn", function (e) {
            ...
            $.ajax({
                type: "GET",
                url: link + "/admin_panel/settings/materials/" + model_id,
    ...
    <script>
        $(".active").change(function (e) {
            ...
            $.ajax({
                type: "GET",
                url: link + "/admin_panel/settings/materials/" + modell_id +"/edit?model_type=" + model_type,
                success: function (data) {
                    Swal.fire({
                        title: data.title,
                        text: data.msg,
